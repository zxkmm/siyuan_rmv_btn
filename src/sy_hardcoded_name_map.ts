...
/*******block context menu********/
["block_menu_turn_into", { html_css_or_field_hardcoded_name: "turnInto", english_human_read_name: "Block Menu: Turn Into", chinese_human_read_name: "块菜单：转换为" }],
["block_menu_ai", { html_css_or_field_hardcoded_name: "ai", english_human_read_name: "Block Menu: AI", chinese_human_read_name: "块菜单：人工智能" }],
["block_menu_copy", { html_css_or_field_hardcoded_name: "copy", english_human_read_name: "Block Menu: Copy", chinese_human_read_name: "块菜单：复制" }],
["block_menu_cut", { html_css_or_field_hardcoded_name: "cut", english_human_read_name: "Block Menu: Cut", chinese_human_read_name: "块菜单：剪切" }],
["block_menu_move", { html_css_or_field_hardcoded_name: "move", english_human_read_name: "Block Menu: Move", chinese_human_read_name: "块菜单：移动" }],
["block_menu_add_to_database", { html_css_or_field_hardcoded_name: "addToDatabase", english_human_read_name: "Block Menu: Add to Database", chinese_human_read_name: "块菜单：添加到数据库" }],
["block_menu_delete", { html_css_or_field_hardcoded_name: "delete", english_human_read_name: "Block Menu: Delete", chinese_human_read_name: "块菜单：删除" }],
["block_menu_enter", { html_css_or_field_hardcoded_name: "enter", english_human_read_name: "Block Menu: Focus", chinese_human_read_name: "块菜单：聚焦" }],
["block_menu_enter_back", { html_css_or_field_hardcoded_name: "enterBack", english_human_read_name: "Block Menu: Focus Parent", chinese_human_read_name: "块菜单：聚焦到上层" }],
["block_menu_insert_before", { html_css_or_field_hardcoded_name: "insertBefore", english_human_read_name: "Block Menu: Insert Before", chinese_human_read_name: "块菜单：起始插入块" }],
["block_menu_insert_after", { html_css_or_field_hardcoded_name: "insertAfter", english_human_read_name: "Block Menu: Insert After", chinese_human_read_name: "块菜单：末尾插入块" }],
["block_menu_jump_to_parent_next", { html_css_or_field_hardcoded_name: "jumpToParentNext", english_human_read_name: "Block Menu: Jump to Parent Next", chinese_human_read_name: "块菜单：跳转到父块的下一个块" }],
["block_menu_jump_to_parent_prev", { html_css_or_field_hardcoded_name: "jumpToParentPrev", english_human_read_name: "Block Menu: Jump to Parent Previous", chinese_human_read_name: "块菜单：跳转到父块的上一个块" }],
["block_menu_jump_to_parent", { html_css_or_field_hardcoded_name: "jumpToParent", english_human_read_name: "Block Menu: Jump to Parent", chinese_human_read_name: "块菜单：跳转到父块" }],
["block_menu_fold", { html_css_or_field_hardcoded_name: "fold", english_human_read_name: "Block Menu: Fold/Unfold", chinese_human_read_name: "块菜单：折叠/展开" }],
["block_menu_attr", { html_css_or_field_hardcoded_name: "attr", english_human_read_name: "Block Menu: Attributes", chinese_human_read_name: "块菜单：属性" }],
["block_menu_appearance", { html_css_or_field_hardcoded_name: "appearance", english_human_read_name: "Block Menu: Appearance", chinese_human_read_name: "块菜单：外观" }],
["block_menu_layout", { html_css_or_field_hardcoded_name: "layout", english_human_read_name: "Block Menu: Layout", chinese_human_read_name: "块菜单：布局" }],
["block_menu_width", { html_css_or_field_hardcoded_name: "widthDrag", english_human_read_name: "Block Menu: Width", chinese_human_read_name: "块菜单：宽度" }],
["block_menu_wechat_reminder", { html_css_or_field_hardcoded_name: "wechatReminder", english_human_read_name: "Block Menu: WeChat Reminder", chinese_human_read_name: "块菜单：微信提醒" }],
["block_menu_quick_make_card", { html_css_or_field_hardcoded_name: "quickMakeCard", english_human_read_name: "Block Menu: Quick Make Card", chinese_human_read_name: "块菜单：快速制卡" }],
["block_menu_plugin", { html_css_or_field_hardcoded_name: "plugin", english_human_read_name: "Block Menu: Plugin", chinese_human_read_name: "块菜单：插件" }],

/******editor context menu ********/
["editor_menu_insert_asset", { html_css_or_field_hardcoded_name: "insertAsset", english_human_read_name: "Editor Menu: Insert Image/File", chinese_human_read_name: "编辑器菜单：插入图片或文件" }],
["editor_menu_start_record", { html_css_or_field_hardcoded_name: "startRecord", english_human_read_name: "Editor Menu: Start Recording", chinese_human_read_name: "编辑器菜单：开始录音" }],
["editor_menu_net_img_to_local", { html_css_or_field_hardcoded_name: "netImg2LocalAsset", english_human_read_name: "Editor Menu: Convert Web Images to Local", chinese_human_read_name: "编辑器菜单：网络图片转换为本地图片" }],
["editor_menu_net_assets_to_local", { html_css_or_field_hardcoded_name: "netAssets2LocalAssets", english_human_read_name: "Editor Menu: Convert Web Assets to Local", chinese_human_read_name: "编辑器菜单：网络资源文件转换本地" }],
["editor_menu_upload_assets_to_cdn", { html_css_or_field_hardcoded_name: "uploadAssets2CDN", english_human_read_name: "Editor Menu: Upload Assets to CDN", chinese_human_read_name: "编辑器菜单：上传资源文件到图床" }],
["editor_menu_refresh", { html_css_or_field_hardcoded_name: "refresh", english_human_read_name: "Editor Menu: Refresh", chinese_human_read_name: "编辑器菜单：刷新" }],
["editor_menu_optimize_typography", { html_css_or_field_hardcoded_name: "optimizeTypography", english_human_read_name: "Editor Menu: Optimize Typography", chinese_human_read_name: "编辑器菜单：优化排版" }],
["editor_menu_fullscreen", { html_css_or_field_hardcoded_name: "fullscreen", english_human_read_name: "Editor Menu: Toggle Fullscreen", chinese_human_read_name: "编辑器菜单：全屏切换" }],
["editor_menu_edit_mode", { html_css_or_field_hardcoded_name: "editMode", english_human_read_name: "Editor Menu: Edit Mode", chinese_human_read_name: "编辑器菜单：模式切换" }],
["editor_menu_wysiwyg", { html_css_or_field_hardcoded_name: "wysiwyg", english_human_read_name: "Editor Menu: WYSIWYG", chinese_human_read_name: "编辑器菜单：所见即所得" }],
["editor_menu_preview", { html_css_or_field_hardcoded_name: "preview", english_human_read_name: "Editor Menu: Export Preview", chinese_human_read_name: "编辑器菜单：导出预览" }],
["editor_menu_readonly", { html_css_or_field_hardcoded_name: "editReadonly", english_human_read_name: "Editor Menu: Read-only Mode", chinese_human_read_name: "编辑器菜单：只读模式" }],
["editor_menu_full_width", { html_css_or_field_hardcoded_name: "fullWidth", english_human_read_name: "Editor Menu: Adaptive Width", chinese_human_read_name: "编辑器菜单：自适应宽度" }],
["editor_menu_doc_info", { html_css_or_field_hardcoded_name: "docInfo", english_human_read_name: "Editor Menu: Document Info", chinese_human_read_name: "编辑器菜单：文档信息" }],
